                            ...
                            <div class="card-body">
                                ...
                                <form wire:submit.prevent="updateCategory">
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input wire:model="name" wire:keyup="generateSlug" class="form-control" name="name" placeholder="Enter category name">
                                        @error('name')
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input wire:model="slug" class="form-control" name="slug" placeholder="Enter category slug">
                                        @error('slug')
                                        <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
