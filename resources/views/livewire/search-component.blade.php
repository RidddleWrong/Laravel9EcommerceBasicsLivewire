                    ...
                    <div class="col-lg-9">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p> We found <strong class="text-brand">{{$products->total()}}</strong> items for you by searching <strong class="text-brand">{{$q}}</strong>!</p>
                            </div>
                                ...
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            ...
                                            <li><a class="{{ $orderBy=='Sort By Newnesss' ? 'active' : '' }}" href="#" wire:click.prevent="changeOrderBy('Sort By Newnesss')">Sort By Newnesss</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
