                                            ...
                                            <div class="product-img product-img-zoom">
                                                <a href="{{route('product.details',$fproduct->slug)}}">
                                                    <img class="default-img"
                                                         src="{{asset('assets/imgs/products/'.$fproduct->image)}}" alt="">
{{--                                                    <img class="hover-img" src="{{asset('assets/imgs/shop/product-'.$fproduct->id.'-2.jpg')}}" alt="">--}}
                                                </a>
                                            </div>
                                        ...
                                        <div class="product-content-wrap">
                                            <div class="product-category">
                                                @foreach($categories as $category)
                                                    @if($category->id == $fproduct->category_id)
...
{{--                                                <span class="old-price">$245.8</span>--}}
                                            ...
                                            <div class="product-action-1 show">
                                                <a wire:click.prevent="store({{$fproduct->id}},'{{$fproduct->name}}',{{$fproduct->regular_price}})" aria-label="Add To Cart" class="action-btn hover-up"><i
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                ...
                                                <img class="hover-img"
                                                     src="{{asset('assets/imgs/shop/product-10-2.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Quick view" class="action-btn hover-up"
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                ...
                                                <img class="hover-img"
                                                     src="{{asset('assets/imgs/shop/product-11-2.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Quick view" class="action-btn hover-up"
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                ...
                                                <img class="hover-img"
                                                     src="{{asset('assets/imgs/shop/product-12-2.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Quick view" class="action-btn hover-up"
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                ...
                                                <img class="hover-img"
                                                     src="{{asset('assets/imgs/shop/product-13-2.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Quick view" class="action-btn hover-up"
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                ...
                                                <img class="hover-img"
                                                     src="{{asset('assets/imgs/shop/product-14-2.jpg')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Quick view" class="action-btn hover-up"
