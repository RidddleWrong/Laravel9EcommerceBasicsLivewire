                                                    ...
                                                    <div class="comment-list">
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                <div class="thumb text-center">
                                                                    <img
                                                                        src="{{asset('assets/imgs/page/avatar-6.jpg')}}"
                                                                        alt="">
                                                        ...
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                <div class="thumb text-center">
                                                                    <img
                                                                        src="{{asset('assets/imgs/page/avatar-7.jpg')}}"
                                                                        alt="">
                                                        ...
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                <div class="thumb text-center">
                                                                    <img
                                                                        src="{{asset('assets/imgs/page/avatar-8.jpg')}}"
                                                                        alt="">
                                                            ...
                                                            <a href="{{ route('product.details',$related_product->slug) }}"
                                                               tabindex="0">
                                                                <img class="default-img"
                                                                     src="{{asset('assets/imgs/shop/product-'.$related_product->id.'-1.jpg')}}"
                                                                     alt="">
                                                                <img class="hover-img"
                                                                     src="{{asset('assets/imgs/shop/product-'.$related_product->id.'-2.jpg')}}"
                                                                     alt="">
                                                            </a>
                                                        </div>
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            @foreach($new_products as $new_product)
                                <div class="single-post clearfix">
                                    <div class="image">
                                        <img src="{{ asset('assets/imgs/shop/thumbnail-'.$new_product->id.'.jpg')}}"
                                             alt="{{$new_product->name}}">
                                        {{-- <img src="{{ asset('assets/imgs/shop/thumbnail-') }}{{$new_product->id}}.jpg" alt="#">--}}
                                    </div>
                                    <div class="content pt-10">
                                        <h6>
                                            <a href="{{ route('product.details',$new_product->slug) }}">{{$new_product->name}}</a>
                                        </h6>
