                                    ...
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="post" action="{{ route('register') }}">
                                            ...
                                            <div class="form-group">
                                                <x-text-input :value="old('name')" type="text" name="name" placeholder="Name" required autofocus autocomplete="name" />
                                            </div>
                                            <div class="form-group">
                                                <x-text-input :value="old('email')" type="text" name="email" placeholder="Email" required />
                                            </div>
                                            <div class="form-group">
